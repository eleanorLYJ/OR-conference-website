...
export default function Home({ username, flavor, ticketNumber, burst }) {
	...
	return (
		...
		<h1 className='text-3xl font-bold mb-6 text-purple-900'>主題</h1>
		<h2 className='animate-fade-in-up text-6xl md:text-[80px] mx-auto text-center max-w-[20ch] text-white font-bold pt-40'>
		...
		<section id="agenda" >
		<div className='flex flex-col items-center justify-center p-10 md:px-0 md:w-3/5 md:mx-auto'>
			<h1 className='text-3xl font-bold mb-6 text-white'>議程</h1>
		</div>
		</section>
 
		<section id="organization">
		<div className='flex flex-col items-center justify-center p-10 md:px-0 md:w-3/5 md:mx-auto'>
		<h1 className='text-3xl font-bold mb-6 text-white'>大會組織</h1>
		</div>
        </section>

		<section id="transportation">
		<div className='flex flex-col items-center justify-center p-10 md:px-0 md:w-3/5 md:mx-auto'>
		<h1 className='text-3xl font-bold mb-6 text-white'>交通資訊</h1>
		...
		<h1 className='text-3xl font-bold mb-6 text-white'>重要日程</h1>
        ...
        <section id="contact">
		<div className='flex flex-col items-center justify-center p-10 md:px-0 md:w-3/5 md:mx-auto'>
		<h1 className='text-3xl font-bold mb-6 text-white'>聯絡</h1>
		<p className='text-xl font-bold mb-6 text-gray-200'>
