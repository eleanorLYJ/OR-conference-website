...
export default function Signup () {
	...
	const handleSignup = async (e) => {
		...
		const sanitizedUnit = sanitizeInput(unit.trim());
		const sanitizedJobTitle = sanitizeInput(jobTitle.trim());
		...
		try {
			const username = `${sanitizedFirstName} ${sanitizedLastName}`.trim();
			if (!username) {
				...
				<main className={`${GeistSans.className} min-h-screen flex items-center justify-center`}>
					<div className='w-full max-w-md p-8 bg-white rounded-lg shadow-md'>
						...
						<div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-4" role="alert">
							...
							<p>For security reasons, please avoid using the following special characters in your inputs:</p>
